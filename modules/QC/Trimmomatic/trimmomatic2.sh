...
ADAPTER=ILLUMINACLIP:/its1/GB_BT2/jianzuoyi/workspace/barley/modules/QC/adapter.fa
THREADS=32
...
OUTDIR=/its1/GB_BT2/jianzuoyi/workspace/barley/modules/QC/Trimmomatic/output2
mkdir -p $OUTDIR
...
touch ${OUTDIR}/trimmomatic2.done
