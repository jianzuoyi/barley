...
REFERENCE=/its1/GB_BT2/jianzuoyi/database/barley/unzip.5k/all_p_h/all_p_h_5k_0.fa
OUTDIR=/its1/GB_BT2/jianzuoyi/workspace/barley/modules/pilon5/pilon_results
TMP_DIR=${OUTDIR}/tmp
mkdir -p $TMP_DIR
THREADS=32

$PILON -Xms100g -Xmx100g -Djava.io.tmpdir=$TMP_DIR \
--genome $REFERENCE \
